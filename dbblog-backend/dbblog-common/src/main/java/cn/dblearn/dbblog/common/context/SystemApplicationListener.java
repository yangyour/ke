...
@Component
public class SystemApplicationListener implements ApplicationListener {
	...
	private void initConstant(){
		Constant.mallSiteCtx = PropertiesUtil.getString("system.mall.siteCtx","");
		Constant.mallSiteUrl = PropertiesUtil.getString("system.mall.siteUrl","");
		Constant.imgSiteUrl = PropertiesUtil.getString("system.imgSiteUrl");

		Constant.UPLOAD_BASE_PATH = PropertiesUtil.getString("system.uploadBasePath");
	}
